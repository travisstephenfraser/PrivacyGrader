"""
Generate the updated UGBA 101A Exam 1 Answer Key / Rubric PDF.
Usage: python generate_rubric.py
Output: data/rubrics/UGBA101A_Exam1_RED_V3.pdf
"""
...
OUTPUT = Path(__file__).parent / "data" / "rubrics" / "UGBA101A_Exam1_RED_V3.pdf"
...
def tier_table(rows, header=True):
    """Build a partial-credit tier table. rows = list of (scenario, points)."""
    ...
    if not header:
        style.add("BACKGROUND", (0, 0), (-1, 0), colors.HexColor("#f8f9fa"))
...
def section_table(rows):
    """Simple two-column table for the score summary."""
...
def build():
    ...
    story += [
        ...
        p("Midterm Exam 1 — ANSWER KEY / GRADING RUBRIC — <font color='#cc0000'><b>Red (A)</b></font>", subtitle_style),
        p("Chapters 1–6  |  Spring 2026  |  UC Berkeley Haas School of Business  |  V3", sub2_style),
        hr(),
        sp(4),
    ]
    ...
    story += [
        ...
        section_table([
            ...
            ["Part I: Multiple Choice (Q1–18)", "60 pts  (3.333334 pts each, capped at 60)"],
            ["Part II: Numeric / Calculation (Q19–25)", "30 pts  (5 pts each)"],
            ["Part III: Short Answer (Q26–28)", "10 pts"],
            ["TOTAL", "100 pts"],
        ]),
        sp(10),
    ]
    ...
    # ── PART I ───────────────────────────────────────────────────────────────
    story += [
        h1("Part I: Multiple Choice  (60 points — 3.333334 points each)"),
        ...
        sp(8),
        mc_table([
            ("Q1","C"),("Q2","B"),("Q3","A"),("Q4","B"),("Q5","B"),("Q6","C"),
            ("Q7","C"),("Q8","B"),("Q9","B"),("Q10","B"),("Q11","B"),("Q12","B"),
            ("Q13","A"),("Q14","A"),("Q15","B"),("Q16","B"),("Q17","D"),("Q18","B"),
        ]),
        sp(14),
    ]
    ...
    # ── PART II ──────────────────────────────────────────────────────────────
    story += [
        h1("Part II: Numeric / Short Calculation  (30 points — 5 points each)"),
        sp(4),
    ]
    ...
    # Q21a
    story += [
        h2("Q21  —  Demand / Consumer Surplus  (5 pts — 2.5 pts per part)"),
        p("<i>Demand equation: P = 50 − 2Q  |  Price = $20</i>", note_style),
        sp(4),
        KeepTogether([
            h3("Q21 Part (a)  —  Quantity Demanded  (2.5 pts)"),
        ...
        sp(8),
        KeepTogether([
            h3("Q21 Part (b)  —  Consumer Surplus  (2.5 pts)"),
    ...
    # Q22
    story += [
        h2("Q22  —  Expected Value / Variance / Standard Deviation  (5 pts: 2 / 2 / 1)"),
        p("<i>Payoffs: $500 (p=0.3), $300 (p=0.5), $100 (p=0.2)</i>", note_style),
        sp(4),
        KeepTogether([
            h3("Q22 Part (a)  —  Expected Value  (2 pts)"),
        ...
        sp(8),
        KeepTogether([
            h3("Q22 Part (c)  —  Standard Deviation  (1 pt)"),
    ...
    story += [
        ...
        sp(8),
        KeepTogether([
            h3("Q23 Part (b)  —  Expected Utility  (1.5 pts)"),
        ...
        sp(8),
        KeepTogether([
            h3("Q23 Part (c)  —  Risk Premium  (2 pts)"),
    ...
    story += [
        ...
        sp(8),
        KeepTogether([
            h3("Q24 Part (b)  —  Direction of Change  (2.5 pts)"),
    ...
    # Q25
    story += [
        h2("Q25  —  International Trade  (5 pts — 2.5 pts per part)"),
        p("<i>Demand: Q = 40 − 2P  |  Supply: Q = (2/3)P  |  World price = $9</i>", note_style),
        sp(4),
        KeepTogether([
            h3("Q25 Part (a)  —  U.S. Quantity Demanded at World Price  (2.5 pts)"),
        ...
        sp(8),
        KeepTogether([
            h3("Q25 Part (b)  —  U.S. Domestic Supply at World Price  (2.5 pts)"),
    ...
    # ── PART III ─────────────────────────────────────────────────────────────
    story += [
        h1("Part III: Short Answer  (10 points)"),
        sp(4),
    ]

    # Q26
    story += [
        h2("Q26  —  Behavioral Economics and Consumer Demand"),
        sp(4),
        KeepTogether([
            h3("Q26 Part (a)  —  Fairness Bias and Demand  (2 pts)"),
        ...
        sp(8),
        KeepTogether([
            h3("Q26 Part (b)  —  Figure 1 and Figure 2: Movement A to B  (2 pts — 1 pt each)"),
    ...
    story += [
        KeepTogether([
            h2("Q27  —  Fill in the Table  (4 pts)"),
    ...
    story += [
        KeepTogether([
            h2("Q28  —  Returns to Scale: q = L² + L  (2 pts)"),
